...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of EGOTableViewPullRefreshS in Markdown format.
  ...
  # s.authors      = { "yufei" => "sisufointernational@gmail.com", "other author" => "email@address.com" }
  # s.author       = 'yufei', 'other author'
  ...
  s.source       = { :git => "https://github.com/sisufo/EGOTableViewPullRefresh.git", :tag => "0.0.1" }
